...
class rvWeaponMinelayer : public rvWeapon {



	//This is a copy of the blaster weapon. I made this copy so that I dont overwrite the defination files for blaster
public:
	CLASS_PROTOTYPE(rvWeaponMinelayer);

	rvWeaponMinelayer(void);
...
private:
	...
	CLASS_STATES_PROTOTYPE(rvWeaponMinelayer);
};

CLASS_DECLARATION(rvWeapon, rvWeaponMinelayer)
END_CLASS
/*
================
rvWeaponMinelayer::rvWeaponMinelayer
================
*/
rvWeaponMinelayer::rvWeaponMinelayer(void) {
}

/*
================
rvWeaponMinelayer::UpdateFlashlight
================
*/
bool rvWeaponMinelayer::UpdateFlashlight(void) {
	if (!wsfl.flashlight) {
		return false;
	}
...
/*
================
rvWeaponMinelayer::Flashlight
================
*/
void rvWeaponMinelayer::Flashlight(bool on) {
	owner->Flashlight(on);
...
/*
================
rvWeaponMinelayer::UpdateAttack
================
*/
bool rvWeaponMinelayer::UpdateAttack(void) {
	// Clear fire forced
	if (fireForced) {
		if (!wsfl.attack) {
			fireForced = false;
...
/*
================
rvWeaponMinelayer::Spawn
================
*/
void rvWeaponMinelayer::Spawn(void) {
...
/*
================
rvWeaponMinelayer::Save
================
*/
void rvWeaponMinelayer::Save(idSaveGame *savefile) const {
...
/*
================
rvWeaponMinelayer::Restore
================
*/
void rvWeaponMinelayer::Restore(idRestoreGame *savefile) {
...
/*
================
rvWeaponMinelayer::PreSave
================
*/
void rvWeaponMinelayer::PreSave(void) {
...
/*
================
rvWeaponMinelayer::PostSave
================
*/
void rvWeaponMinelayer::PostSave(void) {
}
...
CLASS_STATES_DECLARATION(rvWeaponMinelayer)
STATE("Raise", rvWeaponMinelayer::State_Raise)
STATE("Lower", rvWeaponMinelayer::State_Lower)
STATE("Idle", rvWeaponMinelayer::State_Idle)
STATE("Charge", rvWeaponMinelayer::State_Charge)
STATE("Charged", rvWeaponMinelayer::State_Charged)
STATE("Fire", rvWeaponMinelayer::State_Fire)
STATE("Flashlight", rvWeaponMinelayer::State_Flashlight)
END_CLASS_STATES

/*
================
rvWeaponMinelayer::State_Raise
================
*/
stateResult_t rvWeaponMinelayer::State_Raise(const stateParms_t& parms) {
	enum {
		RAISE_INIT,
		RAISE_WAIT,
	};
...
/*
================
rvWeaponMinelayer::State_Lower
================
*/
stateResult_t rvWeaponMinelayer::State_Lower(const stateParms_t& parms) {
	enum {
		LOWER_INIT,
		LOWER_WAIT,
		LOWER_WAITRAISE
...
/*
================
rvWeaponMinelayer::State_Idle
================
*/
stateResult_t rvWeaponMinelayer::State_Idle(const stateParms_t& parms) {
	enum {
		IDLE_INIT,
		IDLE_WAIT,
	};
...
/*
================
rvWeaponMinelayer::State_Charge
================
*/
stateResult_t rvWeaponMinelayer::State_Charge(const stateParms_t& parms) {
	enum {
		CHARGE_INIT,
		CHARGE_WAIT,
	};
...
/*
================
rvWeaponMinelayer::State_Charged
================
*/
stateResult_t rvWeaponMinelayer::State_Charged(const stateParms_t& parms) {
	enum {
		CHARGED_INIT,
		CHARGED_WAIT,
	};
...
/*
================
rvWeaponMinelayer::State_Fire
================
*/
stateResult_t rvWeaponMinelayer::State_Fire(const stateParms_t& parms) {
	enum {
		FIRE_INIT,
		FIRE_WAIT,
	};
...
/*
================
rvWeaponMinelayer::State_Flashlight
================
*/
stateResult_t rvWeaponMinelayer::State_Flashlight(const stateParms_t& parms) {
	enum {
		FLASHLIGHT_INIT,
		FLASHLIGHT_WAIT,
	};
